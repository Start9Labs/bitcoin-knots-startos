...
When your server backs up this service, it will _not_ include the blocks, chainstate, or indexes, so you don't need to worry about it eating your backup drive if you run an archival node.
